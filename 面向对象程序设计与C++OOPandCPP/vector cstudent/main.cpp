...
//    association.show();
    ...
    stuList.add_vector(pstu2);
    stuList.add_vector(pstu1);
    cout << "all students are following without sorted" << endl;
    stuList.show_vector();
    ...
    cout << "show by foreach function "  << endl;
    stuList.show_vector_output();
}
